	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"meta_additional_json": schema.StringAttribute{
				Computed:    true,
				Description: "Additional metadata JSON as returned by Open WebUI. It holds neither `knowledge`, which `knowledge_ids` reports, nor the server-derived `chat_variables_schema`.",
			},
			...
			"tool_ids": schema.ListAttribute{
				ElementType: types.StringType,
				Computed:    true,
				Description: "List of tool IDs attached to the model by default.",
			},
			"skill_ids": schema.ListAttribute{
				ElementType: types.StringType,
				Computed:    true,
				Description: "List of skill IDs attached to the model by default.",
			},
			"knowledge_ids": schema.ListAttribute{
				ElementType: types.StringType,
				Computed:    true,
				Description: "List of knowledge base IDs attached to the model. Knowledge entries naming a single file or note are not represented.",
			},
			"default_feature_ids": schema.ListAttribute{
				ElementType: types.StringType,
				Computed:    true,
				Description: "List of feature IDs enabled by default.",
			},
			"params": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"temperature":       schema.Float64Attribute{Computed: true, Description: "Sampling temperature, 0 to 2. Lower values are more deterministic."},
					...
					"mirostat_tau":      schema.Float64Attribute{Computed: true, Description: "Mirostat target entropy. A lower value makes the output more focused."},
					"mirostat_eta":      schema.Float64Attribute{Computed: true, Description: "Mirostat learning rate. It sets how fast the sampler reacts to the generated text."},
			...
			"capabilities": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"file_context":     schema.BoolAttribute{Computed: true, Description: "Whether uploaded files go into the prompt as context."},
					...
					"terminal":         schema.BoolAttribute{Computed: true, Description: "Whether the model can run terminal commands."},
					"memory":           schema.BoolAttribute{Computed: true, Description: "Whether the model reads and writes user memories."},
					"builtin_tools":    schema.BoolAttribute{Computed: true, Description: "Whether Open WebUI's built-in tools are offered to the model."},
